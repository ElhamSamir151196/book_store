        ...
        <?php if(isset($_SESSION['order'])):?>
            <table class="table table-striped-columns">
                ...
                <tbody>
                    ...
                    <?php if($_SESSION['order']['statues']!="pending"):?>
                    <tr>
            ...
            <?php if($_SESSION['order']['statues']=="pending"):?>
                <form class="mb-5" action="order-update" method="post">
                    <input type="hidden" name="id" value="<?= $_SESSION['order']['id']?>">
                    <div class="mb-3">
                        <label for="statues"> Statues</label>
                        <select class="contact__input" id="statues" name="statues">
                        <option value="pending">pending</option>
                        <option value="done">done</option>
                        <option value="canceled">canceled</option>
                        </select>
                    </div>
                    <button class="primary-button w-100 rounded-2"> Change Statues</button>
                </form>
            <?php endif;?>
        <?php endif;?>
