    ...
    <main>
      ...
      <section class="section-container d-flex align-items-center py-4">
        ...
        <div class="w-50">
          ...
          <p class="m-0">
            شركتنا هي أكبر شركة متخصصة لبيع الكتب أونلاين و توصيلها حتي
      ...
      <section class="text-white bg-black">
        <div class="section-container py-5">
          ...
          <p class="m-0">
            رؤيتنا هي أن نكون الشركة الرائدة في مجال بيع الكتب في مصر، وأن
            نوفر لعملائنا أفضل الكتب ذات الجودة العالية والأسعار المعقولة.
          </p>
          <p class="m-0">
           اكبر مجموعة متنوعه من الكتب و خصومات حصرية
            في كافة المجالات التعليمية والثقافية و الترفيهية تناسب جميع الاعمار
          </p>
        </div>
      </section>
      ...
      <section class="section-container d-flex align-items-center py-5">
        <div class="w-50">
          ...
          <p class="m-0">
            نحن نؤمن بأن الكتب هي جزء مهم من شخصية الفرد، لذلك هدفنا هو أن
            نوفر لعملائنا أفضل تجربة تسوق ممكنة، وأن نجعل من عملية شراء الكتب
            تجربة ممتعة وسهلة.
          </p>
          <p>
            ونسعى جاهدين لتحقيق رؤيتنا وهدفنا من خلال تقديم مجموعة واسعة من
            الكتب ذات الجودة العالية والأسعار المعقولة، وتوفير خدمة عملاء
            ممتازة.
          </p>
        </div>
        <div class="about__img text-end w-50">
          <img class="w-100" src="../app/assets/images/about-2.png" alt="" />
        </div>
      </section>
